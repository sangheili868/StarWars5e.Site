<script lang="ts">
  ...
  import { EquipmentType, WeaponType, isWeaponType } from '@/types/lootTypes'
    ...
    get headers () {
      return [
        ...
        },
        {
          ...
          filterFunction: ({ propertiesMap }: WeaponType, filterValue: string[]) => this.filterProperties(propertiesMap, filterValue)
        },
